...
setup(
    ...
    scripts=['bin/grace'],
    packages=['grace'],
    install_requires=['libsass == 0.3.0.dev', 'argparse', 'setuptools', 'slimit', 'cssmin', 'pyjsdoc'],
    dependency_links=['https://github.com/mdiener/libsass-python/releases/download/0.3.0.dev/libsass-0.3.0.dev.tar.gz'],
